...
template <> constexpr inline auto ReviewWidget::qt_create_metaobjectdata<qt_meta_tag_ZN12ReviewWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'openFastReview'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'openScenarioReview'
...
void ReviewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->openFastReview(); break;
        case 2: _t->openScenarioReview(); break;
        case 3: _t->onButtonClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ReviewWidget::*)()>(_a, &ReviewWidget::backToMain, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ReviewWidget::*)()>(_a, &ReviewWidget::openFastReview, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ReviewWidget::*)()>(_a, &ReviewWidget::openScenarioReview, 2))
            return;
    }
}
...
// SIGNAL 0
void ReviewWidget::backToMain()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ReviewWidget::openFastReview()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void ReviewWidget::openScenarioReview()
{
